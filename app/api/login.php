...
if ($row = mysqli_fetch_assoc($result)) {
    if (password_verify($password, $row['password'])) {
        ...
        $redirect = '/metrologia/admin/reportes.php';
        if ($row['rol'] === 'laboratorio') $redirect = '/metrologia/laboratorio/tablero.php';
        elseif ($row['rol'] === 'usuario') $redirect = '/metrologia/index.html';
